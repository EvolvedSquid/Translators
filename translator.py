...
num_samples = 1400  # Number of samples to train on (goes for each language).
save_model = True
...
# Encode French data
english2fra_input_data = np.zeros((num_samples, max_encoder_seq_length, num_english_tokens), dtype='float32')
french_input_data = np.zeros((num_samples, max_decoder_seq_length, num_french_tokens), dtype='float32')
french_target_data = np.zeros((num_samples, max_decoder_seq_length, num_french_tokens), dtype='float32')
...
# Encode German data
english2deu_input_data = np.zeros((num_samples, max_encoder_seq_length, num_english_tokens), dtype='float32')
german_input_data = np.zeros((num_samples, max_decoder_seq_length, num_german_tokens), dtype='float32')
german_target_data = np.zeros((num_samples, max_decoder_seq_length, num_german_tokens), dtype='float32')
...
# Create save folder
if save_model:
    newpath = 'Saves/eng2fra&deu-%sx%s' % (num_samples, latent_dim)
